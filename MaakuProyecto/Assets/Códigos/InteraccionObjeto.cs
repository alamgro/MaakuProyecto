...
public class InteraccionObjeto : MonoBehaviour
{
	...
	{
		if (Input.GetKeyDown(KeyCode.E) && !GameManager.estaMoviendose && countItem < itemSprites.Length) //Si presiona E y aún quedan items disponibles, entonces cambia de sprite
		{
	...
	{
		if (Input.GetKeyDown(KeyCode.E)&& !GameManager.estaMoviendose && !inventory.isFull) 
		{
	...
	{
		if(Input.GetKeyDown(KeyCode.E) && !GameManager.estaMoviendose)
		{
